...
<body class="clearfix">
    ...
    <h1 style="margin-left:320px; margin-top:10px;"><center>Train Schedule</center></h1>

    <form action="/SlRail/trainschedule/sm_filter" method="get" style="text-align: center; margin-top: 15px; margin-left:130px;">
       
       <label for="startStation" >Start Station:</label>
       <select id="From" name="departure_station" required>
       </select>

       <label for="endStation" style="margin-left: 30px;">End Station:</label>
       <select id="destination" name="destination_station" style="margin-left: 10px;" required>
       </select>        

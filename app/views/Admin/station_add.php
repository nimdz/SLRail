...
<head>
    ...
    <title>Add Station Details</title>
    <style>
      .container1{
       margin-left: 250px;
       width:1000px;
...
<h2 style="margin-left:200px; font-family:'Courier New', Courier, monospace;font-weight:bold;">Add Station</h2>


    <div class="container1">
        <form action="/SlRail/station/addStation" method="post">
            ...
            <center><button type="submit" style="margin-bottom:80px; border-radius:50px;">Add Station</button></center>   
        </form>
    </div>

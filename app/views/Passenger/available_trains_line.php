...
<head>
    ...
    <link rel="stylesheet" href="/SlRail/public/css/Passenger/train_line.css">
...
<body class="clearfix">
    ...
    <h3 style="margin-left: 200px; margin-top: 30px; font-family: 'Courier New', Courier, monospace; font-size: 32px; margin-bottom: 30px;"><center>Available Trains in <?= isset($_GET['route']) ?  ucwords($_GET['route'])  : 'Unknown Route' ?></center></h3>


    <?php include('passenger_sidebar.php'); ?>
    <script src="/SlRail/public/Js/stations.js" type="text/javascript"></script>
        <?php
        // Set $departure_date to the current date
        $departure_date = date('Y-m-d');
        ?>

    <?php if (isset($result) && !empty($result)) : ?>
        <div class="schedule-container" style="margin-left:290px; ">
            <?php foreach ($result as $index => $train) : ?>
                <div class="schedule-card">
                    ...
                    <div class="stations1" style=" margin-left:300px;">
                        <?= $departure_station ?>
                        <span class="duration"style="margin-left:170px;"><?=$durationHours?>h<?=$durationMinutes?>m

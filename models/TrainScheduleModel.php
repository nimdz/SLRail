...
class TrainScheduleModel
{
    ...
    public function createSchedule($departure_station, $destination_station, $departure_time, $arrival_time, $schedule_date)
    {
        $conn = $this->db->getConnection();

        $sql = "INSERT INTO train_schedules (departure_station, destination_station, departure_time, arrival_time, schedule_date) VALUES (?, ?, ?, ?, ?)";
        ...
        $stmt->bind_param("sssss", $departure_station, $destination_station, $departure_time, $arrival_time, $schedule_date);

...
<body>
    ...
    <!--<div class="sidebar">
      ...
      <a href="#"><img width="100px" src="/SlRail/public/assets/logo.jpg"> </a>
           ...
           <a href="/SlRail/trainschedule/addSchedule">
                <span class="material-symbols-outlined">
                  calendar_month
                </span>
                Add Train Schedule
          ...
          <!--  <a href="/SlRail/views/StationMaster/sm_add_announcements.php">
                 <span class="material-symbols-outlined">
                  campaign
                </span>
                Add Announcement               
    ...
    <div class="content">
      ...
      <p><center>"Welcome to the Station Master Dashboard, your central hub for efficient railway management.
